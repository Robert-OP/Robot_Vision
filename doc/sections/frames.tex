...
The following equation shows the relationship between the robot frame and the world frame.
\begin{align*}
\begin{bmatrix}
x_r \\
y_r \\
...
\end{bmatrix}
\end{align*}
It is assumed that the z axis is on the same axis in both robot and world coordinate, because the blocks lay on the XY plane. Therefore the above equation can we written as: 
\begin{align}
\begin{bmatrix}
x_r \\
y_r \\
